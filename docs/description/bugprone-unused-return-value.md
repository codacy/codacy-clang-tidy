...
<span class="title-ref">^::std::error_code$</span>,
<span class="title-ref">^::std::error_condition$</span>,
<span class="title-ref">^::std::errc$</span>,
<span class="title-ref">^::std::expected$</span>,
<span class="title-ref">^::boost::system::error_code$</span>
...
`cert-err33-c <../cert/err33-c>` is an alias of this check that checks a
