...
Pass by
Value](https://web.archive.org/web/20140205194657/http://cpp-next.com/archive/2009/08/want-speed-pass-by-value/).
...
When <span class="title-ref">true</span>, the check only warns about
copied parameters that are already passed by value. Default is
