clang-tidy - bugprone-pointer-arithmetic-on-polymorphic-object
...
When <span class="title-ref">true</span>, objects that only inherit a
virtual function are not checked. Classes that do not declare a new
virtual function are excluded by default, as they make up the majority
of false positives. Default: <span class="title-ref">false</span>.
