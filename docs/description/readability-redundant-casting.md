...
When set to <span class="title-ref">false</span>, the check will
consider type aliases, and when set to
<span class="title-ref">true</span>, it will resolve all type aliases
and operate on the underlying types. Default is
