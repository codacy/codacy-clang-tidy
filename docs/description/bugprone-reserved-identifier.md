...
<span class="title-ref">cert-dcl37-c</span> and
<span class="title-ref">cert-dcl51-cpp</span> redirect here as an alias
for this check.
...
e.g. standard library implementors, to ensure they don't infringe on the
user namespace.
...
If <span class="title-ref">true</span>, inverts the check, i.e. flags
names that are not reserved. Default is
