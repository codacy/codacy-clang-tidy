clang-tidy - portability-simd-intrinsics
...
If the option `Suggest` is set to <span class="title-ref">true</span>,
for
...
<span class="title-ref">false</span>), the check will suggest
...
<span class="title-ref">-std=c++20</span> and
