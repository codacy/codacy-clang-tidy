...
>   suspension point is problematic as the lock held by this object
...
`my::lockable; a::b;::my::other::lockable;` The default value of this
option is
<span class="title-ref">"std::lock_guard;std::scoped_lock"</span>.
...
Eg: `my::safe::awaitable;other::awaitable` The default value of this
option is empty string <span class="title-ref">""</span>.
