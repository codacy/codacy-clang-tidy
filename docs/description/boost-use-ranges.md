...
`std::next_permutation`, `std::none_of`, `std::parital_sum`,
...
If <span class="title-ref">true</span> (default value) the boost headers
are included as system headers with angle brackets
(<span class="title-ref">\#include \<boost.hpp\></span>), otherwise
quotes are used (<span class="title-ref">\#include "boost.hpp"</span>).
...
When <span class="title-ref">true</span> (default
<span class="title-ref">false</span>), fixes which involve reverse
ranges will use the pipe adaptor syntax instead of the function syntax.
