...
string literals. Setting this option to
<span class="title-ref">true</span> enables the replacement. The default
value is <span class="title-ref">false</span> (shorter literals are not
replaced).
