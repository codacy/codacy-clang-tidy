...
will ignore leading and trailing underscores and case when comparing
names -- otherwise they are taken into account.
...
When <span class="title-ref">true</span>, the check will ignore the
single argument.
...
When <span class="title-ref">true</span>, the check will add argument
comments in the format `/*ParameterName=*/` right before the boolean
literal argument.
