...
When set to <span class="title-ref">true</span> the check will add const
qualifiers variables defined as `auto *` or `auto &` when applicable.
...
If AddConstToQualified is set to <span class="title-ref">false</span>,
