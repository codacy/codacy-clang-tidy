...
<span class="title-ref">none</span> (ignore the number of lines).
...
is <span class="title-ref">none</span> (ignore the number of branches).
...
is <span class="title-ref">none</span> (ignore the number of
parameters).
...
is <span class="title-ref">none</span> (ignore the nesting level).
...
The default is <span class="title-ref">none</span> (ignore the number of
