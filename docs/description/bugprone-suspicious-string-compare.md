...
implicit comparison. <span class="title-ref">true</span> by default.
...
When <span class="title-ref">true</span>, the check will warn on logical
not comparison. <span class="title-ref">false</span> by default.
